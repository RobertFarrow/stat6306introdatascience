...
REsteem <- Esteem[,c("Esteem1", "LIncome2005", "AFQT", "Gender")]
...
```{r}
myLogit <- glm(Esteem1 ~ LIncome2005 + AFQT + Gender, data=REsteem)
myLogit
summary(myLogit)
```

There is strong evidence at the alpha = 0.05 level of significance (p-value = 0.0181) that the AFQT variable is a strong indicator for a persons self esteem.
